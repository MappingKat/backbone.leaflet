...
//   // object.
  ...
  NPMap.noConflict = function () {
    Backbone.NPMap = previousBackboneNPMap;
    return this;
  };
  ...
  var GeoModel = NPMap.GeoModel = Backbone.Model.extend({
  ...
  var GeoCollection = NPMap.GeoCollection = Backbone.Collection.extend({
    // Default model.
    model: GeoModel,
  ...
  var PopupView = NPMap.PopupView = function ( options ) {
  ...
  var MapView = NPMap.MapView = function ( options ) {
